...
var GlobalConfig = {
  ...
  input: {
    // transfer: false,
    dateConfig: {
      startWeek: 1 // parseFormat: 'yyyy-MM-dd HH:mm:ss.SSS',
      // labelFormat: '',
      // valueFormat: ''
...
var Methods = {
  ...
  handleReserveStatus: function handleReserveStatus() {
    ...
    this.selectRow = reserveRadioRow; // 复选框
    ...
    if (rows) {
      ...
      if (expanded) {
        ...
        xe_utils_amd_xe_utils_default.a.remove(rowExpandeds, function (row) {
          return (!toggleMethod || toggleMethod({
            expanded: expanded,
            column: column,
            columnIndex: columnIndex,
            $columnIndex: $columnIndex,
    ...
    return new Promise(function (resolve) {
      ...
      loadMethod({
        ...
        if (childs) {
          ...
          if (_this34.isCheckedByCheckboxRow(row)) {
...
/* harmony default export */ var table = ({
  ...
  computed: {
    ...
    sortOpts: function sortOpts() {
      return Object.assign({
        orders: ['asc', 'desc', null]
      }, conf.sortConfig, this.sortConfig);
    },
  ...
  created: function created() {
    ...
    } else if (!v_x_e_table._export && (this.importConfig || this.expandConfig)) {
...
/* harmony default export */ var src_toolbar = ({
  ...
  methods: {
    ...
    triggerZoomEvent: function triggerZoomEvent(evnt) {
      ...
      $xegrid.$emit('zoom', {
        $grid: $xegrid,
        maximize: $xegrid.isMaximized(),
        type: $xegrid.isMaximized() ? 'max' : 'revert'
      }, evnt);
    }
  }
});
...
/* harmony default export */ var src_pager = ({
  ...
  render: function render(h) {
    ...
    var vSize = this.vSize,
        align = this.align;
    return h('div', {
      class: ['vxe-pager', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, "align--".concat(align), align), _defineProperty(_ref, 'is--border', this.border), _defineProperty(_ref, 'is--background', this.background), _defineProperty(_ref, 'is--perfect', this.perfect), _defineProperty(_ref, 'is--loading', this.loading), _ref)]
    }, [h('div', {
...
function isDateDisabled(_vm, item) {
  var disabledMethod = _vm.dateOpts.disabledMethod;
...
function renderNumberIcon(h, _vm) {
  return h('span', {
    ...
    class: ['vxe-input--number-prev-icon', conf.icon.inputPrevNum]
  })]), h('span', {
    ...
    class: ['vxe-input--number-next-icon', conf.icon.inputNextNum]
  })])]);
}
...
function renderDatePickerIcon(h, _vm) {
  return h('span', {
    ...
    class: ['vxe-input--date-picker-icon', conf.icon.inputDate]
  })]);
}
...
function renderPasswordIcon(h, _vm) {
  ...
  return h('span', {
    ...
    class: ['vxe-input--pwd-icon', showPwd ? conf.icon.inputShowPwd : conf.icon.inputPwd]
  })]);
}
...
function renderSuffixIcon(h, _vm) {
  ...
  return isClearable || suffixIcon ? h('span', {
    ...
    class: ['vxe-input--clear-icon', conf.icon.inputClear]
  }) : null]) : null;
}
  ...
  computed: {
    ...
    dateLabelFormat: function dateLabelFormat() {
      if (this.isDatePicker) {
        return this.dateOpts.labelFormat || conf.i18n("vxe.input.date.labelFormat.".concat(this.type));
      }
    ...
    weekDatas: function weekDatas() {
      var sWeek = xe_utils_amd_xe_utils_default.a.toNumber(this.dateOpts.startWeek);
      var weeks = [sWeek];
    ...
    dayList: function dayList() {
      ...
      if (selectMonth && currentDate) {
        ...
        var startDay = xe_utils_amd_xe_utils_default.a.getWhatDay(selectMonth, prevOffsetDay);
  ...
  methods: {
    ...
    afterCheckValue: function afterCheckValue() {
      ...
      if (!inpAttrs.readonly) {
        if (isNumber) {
          if (value || xe_utils_amd_xe_utils_default.a.isNumber(value)) {
            var inputValue = this.type === 'integer' ? xe_utils_amd_xe_utils_default.a.toInteger(value) : xe_utils_amd_xe_utils_default.a.toNumber(value);
          ...
          if (inpVal) {
            inpVal = xe_utils_amd_xe_utils_default.a.toStringDate(inpVal, dateLabelFormat);

            if (xe_utils_amd_xe_utils_default.a.isDate(inpVal)) {
    ...
    numberDropDown: function numberDropDown() {
    ...
    dateParseValue: function dateParseValue(date) {
      var dateLabelFormat = this.dateLabelFormat,
          dateOpts = this.dateOpts;
      var dValue = date ? xe_utils_amd_xe_utils_default.a.toStringDate(date, dateOpts.parseFormat) : null;
      var dLabel = '';
    ...
    dateChangeValue: function dateChangeValue(date) {
      ...
      if (type === 'week') {
        date = xe_utils_amd_xe_utils_default.a.getWhatWeek(date, 0, dateOpts.startWeek);
      }
...
/* harmony default export */ var src_button = ({
  ...
  render: function render(h) {
    ...
    return $scopedSlots.dropdowns ? h('div', {
      ...
      class: "vxe-button--dropdown-arrow ".concat(conf.icon.dropdownBtn)
    })])), h('div', {
      ref: 'panel',
    ...
    updateStatus: function updateStatus(scope, itemValue) {
      ...
      if (property) {
        this.validItemRules('change', property, itemValue).then(function () {
          _this4.clearValidate(property);
        }).catch(function (_ref6) {
          var rule = _ref6.rule,
              rules = _ref6.rules;

          var rest = _this4.invalids.find(function (rest) {
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      props: {
        ...
        suffixIcon: visiblePanel ? conf.icon.selectOpen : conf.icon.selectClose,
        value: selectLabel
      },
      on: {
  ...
  methods: {
    ...
    setCurrentOption: function setCurrentOption(option) {
      ...
      if (option) {
        ...
        this.$nextTick(function () {
          DomTools.toView(_this2.$refs.panel.querySelector("[data-option-id='".concat(option.id, "']")));
        });
      }
    },
...
/* harmony default export */ var import_panel = ({
  ...
  computed: {
    ...
    parseTypeLabel: function parseTypeLabel() {
      ...
      if (type) {
        var selectItem = typeList.find(function (item) {
...
var components = [// 模块
packages_column, packages_header, packages_footer, filter, packages_loading, packages_grid, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_textarea, packages_button, packages_modal, packages_tooltip, packages_form, packages_select, edit, packages_export, keyboard, validator, packages_resize, // 核心
packages_table]; // 默认安装
