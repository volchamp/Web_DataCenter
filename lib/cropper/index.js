    ...
    return function (t) {
        ...
        function u(t, e) {
            for (var o = [], n = {}, r = 0; r < t.length; r++) {
                var i = t[r], s = e.base ? i[0] + e.base : i[0], a = {css: i[1], media: i[2], sourceMap: i[3]};
        ...
        function v(t, e) {
            ...
            if (e.singleton) {
                ...
                var n = o.css, r = o.sourceMap, i = void 0 === e.convertToAbsoluteUrls && r;
        ...
        t.exports = function (t) {
            ...
            var o = e.protocol + "//" + e.host, n = o + e.pathname.replace(/\/[^\/]*$/, "/");
        ...
        var n = function () {
            ...
            }, [t.imgs ? o("div", {staticClass: "cropper-box"}, [o("div", {
                directives: [{
                    name: "show",
                    rawName: "v-show",
                    value: !t.loading,
        ...
        var i = r, s = {
            ...
            props: {
                ...
                limitMinSize: {
                    type: [Number, Array, String], default: function () {
                        return 10
                    }
                }
            },
            ...
            methods: {
                checkOrientationImage: function (t, e, o, n) {
                    var r = this, i = document.createElement("canvas"), s = i.getContext("2d");
                    switch (s.save(), e) {
                        case 2:
                            i.width = o, i.height = n, s.translate(o, 0), s.scale(-1, 1);
                            break;
                        case 3:
                            i.width = o, i.height = n, s.translate(o / 2, n / 2), s.rotate(180 * Math.PI / 180), s.translate(-o / 2, -n / 2);
                            break;
                        case 4:
                            i.width = o, i.height = n, s.translate(0, n), s.scale(1, -1);
                            break;
                        case 5:
                            i.height = o, i.width = n, s.rotate(.5 * Math.PI), s.scale(1, -1);
                            break;
                        case 6:
                            i.width = n, i.height = o, s.translate(n / 2, o / 2), s.rotate(90 * Math.PI / 180), s.translate(-o / 2, -n / 2);
                            break;
                        case 7:
                            i.height = o, i.width = n, s.rotate(.5 * Math.PI), s.translate(o, -n), s.scale(-1, 1);
                            break;
                        case 8:
                            i.height = o, i.width = n, s.translate(n / 2, o / 2), s.rotate(-90 * Math.PI / 180), s.translate(-o / 2, -n / 2);
                            break;
                        default:
                            i.width = o, i.height = n
                    }
                    s.drawImage(t, 0, 0, o, n), s.restore(), i.toBlob(function (t) {
                    ...
                    var e = this;
                    t.preventDefault();
                    var o = this.scale, n = this.touches[0].clientX, r = this.touches[0].clientY,
                        i = t.touches[0].clientX, s = t.touches[0].clientY, a = this.touches[1].clientX,
                        c = this.touches[1].clientY, h = t.touches[1].clientX, p = t.touches[1].clientY,
                        u = Math.sqrt(Math.pow(n - a, 2) + Math.pow(r - c, 2)),
                        d = Math.sqrt(Math.pow(i - h, 2) + Math.pow(s - p, 2)) - u, l = 1,
                    ...
                    o = r - this.moveX, n = i - this.moveY, this.$nextTick(function () {
                        if (e.centerBox) {
                            var t, r, i, s, a = e.getImgAxis(o, n, e.scale), c = e.getCropAxis(),
                                h = e.trueHeight * e.scale, p = e.trueWidth * e.scale;
                            switch (e.rotate) {
                                case 1:
                                case-1:
                                case 3:
                    ...
                    var e = this;
                    t.preventDefault();
                    var o = this.scale, n = t.deltaY || t.wheelDelta;
                    ...
                    t.preventDefault();
                    var o = t.clientX ? t.clientX : t.touches ? t.touches[0].clientX : 0,
                        n = t.clientY ? t.clientY : t.touches ? t.touches[0].clientY : 0, r = this.w, i = this.h, s = 0,
                        a = 0;
                    if (this.centerBox) {
                    ...
                    var t = this.limitMinSize, e = new Array;
                    ...
                    var o = this, n = 0, r = 0;
                    t && (t.preventDefault(), n = t.clientX ? t.clientX : t.touches[0].clientX, r = t.clientY ? t.clientY : t.touches[0].clientY), this.$nextTick(function () {
                    ...
                    var n = {x1: 0, x2: 0, y1: 0, y2: 0}, r = this.trueWidth * o, i = this.trueHeight * o;
                    switch (this.rotate) {
                        case 0:
                    ...
                    var e = this, o = document.createElement("canvas"), n = new Image, r = this.rotate,
                        i = this.trueWidth, s = this.trueHeight, a = this.cropOffsertX, c = this.cropOffsertY;
                    ...
                    n.onload = function () {
                        if (0 !== e.cropW) {
                            ...
                            var d = e.cropW * u, l = e.cropH * u, f = i * e.scale * u, g = s * e.scale * u,
                            ...
                            switch (h(d, l), p.save(), r) {
                                ...
                                case 1:
                                case-3:
                                    e.full ? (h(d / e.scale, l / e.scale), v = v / e.scale + (f / e.scale - g / e.scale) / 2, m = m / e.scale + (g / e.scale - f / e.scale) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, m, -v - g / e.scale, f / e.scale, g / e.scale)) : (v += (f - g) / 2, m += (g - f) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, m, -v - g, f, g));
                                    break;
                                case 2:
                                case-2:
                                    e.full ? (h(d / e.scale, l / e.scale), p.rotate(90 * r * Math.PI / 180), v /= e.scale, m /= e.scale, p.drawImage(n, -v - f / e.scale, -m - g / e.scale, f / e.scale, g / e.scale)) : (p.rotate(90 * r * Math.PI / 180), p.drawImage(n, -v - f, -m - g, f, g));
                                    break;
                                case 3:
                                case-1:
                                    e.full ? (h(d / e.scale, l / e.scale), v = v / e.scale + (f / e.scale - g / e.scale) / 2, m = m / e.scale + (g / e.scale - f / e.scale) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, -m - f / e.scale, v, f / e.scale, g / e.scale)) : (v += (f - g) / 2, m += (g - f) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, -m - f, v, f, g));
                                    break;
                                default:
                                    e.full ? (h(d / e.scale, l / e.scale), p.drawImage(n, v / e.scale, m / e.scale, f / e.scale, g / e.scale)) : p.drawImage(n, v, m, f, g)
                            }
                            ...
                            var w = i * e.scale, x = s * e.scale, C = o.getContext("2d");
                            switch (C.save(), r) {
                                case 0:
                    ...
                    var e = this.cropW, o = this.cropH, n = this.scale, r = {};
                    r.div = {width: "".concat(e, "px"), height: "".concat(o, "px")};
                    var i = (this.x - this.cropOffsertX) / n, s = (this.y - this.cropOffsertY) / n;
                    ...
                    var t = 1, e = (this.trueWidth, this.trueHeight), o = this.mode.split(" ");
                    switch (o[0]) {
                        case"contain":
                        ...
                        default:
                            try {
                                ...
                                if (-1 !== n.search("px") && (n = n.replace("px", ""), t = parseFloat(n) / this.trueWidth), -1 !== n.search("%") && (n = n.replace("%", ""), t = parseFloat(n) / 100 * this.w / this.trueWidth), 2 === o.length && "auto" === n) {
                                    var r = o[1];
                                    -1 !== r.search("px") && (r = r.replace("px", ""), t = (e = parseFloat(r)) / this.trueHeight), -1 !== r.search("%") && (r = r.replace("%", ""), t = (e = parseFloat(r) / 100 * this.h) / this.trueHeight)
                                }
                            } catch (e) {
                                t = 1
                            }
                    ...
                    if ("" !== this.imgs && null !== this.imgs) {
                        ...
                        var o = this.w, n = this.h;
                        if (this.centerBox) {
                            var r = this.trueWidth * this.scale, i = this.trueHeight * this.scale;
                            o = r < o ? r : o, n = i < n ? i : n
                        }
                        var s = t || parseFloat(this.autoCropWidth), a = e || parseFloat(this.autoCropHeight);
                        0 !== s && 0 !== a || (s = .8 * o, a = .8 * n), s = s > o ? o : s, a = a > n ? n : a, this.fixed && (a = s / this.fixedNumber[0] * this.fixedNumber[1]), a > this.h && (s = (a = this.h) / this.fixedNumber[1] * this.fixedNumber[0]), this.changeCrop(s, a)
                    }
                    ...
                    var n = !0;
                    if (this.centerBox) {
                        var r = this.getImgAxis(t, e, o), i = this.getCropAxis();
        ...
        var a = function (t, e, o, n, r, i, s, a) {
            ...
            if (e && (h.render = e, h.staticRenderFns = o, h._compiled = !0), n && (h.functional = !0), i && (h._scopeId = "data-v-" + i), s ? (c = function (t) {
        ...
        e.default = {version: "0.5.2", install: h, VueCropper: c, vueCropper: c}
    }])
});
