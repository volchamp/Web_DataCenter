...
!function (t) {
    ...
    var e = function () {
        ...
        function n(t) {
            this._handlers = [], this._handlersChanged = t
        }

        return n.prototype.addHandler = function (n, r) {
            n = t.asFunction(n), this._handlers.push(new e(n, r)), t.isFunction(this._handlersChanged) && this._handlersChanged()
        }, n.prototype.removeHandler = function (e, n) {
            var r = !1;
            e = t.asFunction(e);
            for (var i = 0; i < this._handlers.length; i++) {
                var o = this._handlers[i];
                if ((o.handler == e || null == e) && (o.self == n || null == n) && (this._handlers.splice(i, 1), r = !0, e && n)) break
            }
            r && t.isFunction(this._handlersChanged) && this._handlersChanged()
        }, n.prototype.removeAllHandlers = function () {
            var e = this._handlers.length > 0;
            this._handlers.length = 0, e && t.isFunction(this._handlersChanged) && this._handlersChanged()
    ...
    function r(t, e) {
        return null == t ? null : o(e) ? l(t.implementsInterface) && t.implementsInterface(e) ? t : null : t instanceof e ? t : null
    }

    function i(t) {
        return o(t) || s(t) || u(t) || c(t)
    }
    ...
    function p(t) {
        return null != t && "object" == typeof t && !c(t) && !h(t)
    }

    function f(t) {
        return s(t) ? e.Number : u(t) ? e.Boolean : c(t) ? e.Date : o(t) ? e.String : h(t) ? e.Array : e.Object
    }
    ...
    function d(n, r, i) {
        if (null != n) {
            if (o(n)) switch (r) {
                case e.Number:
                    var s = t.Globalize.parseFloat(n, i);
                    return isNaN(s) ? n : s;
                case e.Date:
                    var a = t.Globalize.parseDate(n, i);
                    return a || i || !n || (a = new Date(n)), a && isFinite(a.getTime()) ? a : n;
                case e.Boolean:
            ...
            if (r == e.String) return t.Globalize.format(n, i)
        }
        return n
    }
    ...
    function m(t, e) {
        return void 0 === e && (e = !0), g(e && null == t || o(t), "String expected."), t
    }

    function _(t, e, n) {
        if (void 0 === e && (e = !1), void 0 === n && (n = !1), g(e && null == t || s(t), "Number expected."), n && t && t < 0) throw"Positive number expected.";
        return t
    }

    function v(t, e) {
        return void 0 === e && (e = !1), g(e && null == t || u(t), "Boolean expected."), t
    }

    function y(t, e) {
        return void 0 === e && (e = !0), g(e && null == t || l(t), "Function expected."), t
    }
    ...
    t.getVersion = function () {
    ...
    }(t.Key || (t.Key = {})), function (t) {
        t[t.Object = 0] = "Object", t[t.String = 1] = "String", t[t.Number = 2] = "Number", t[t.Boolean = 3] = "Boolean", t[t.Date = 4] = "Date", t[t.Array = 5] = "Array"
    }(e = t.DataType || (t.DataType = {})), t.tryCast = r, t.isPrimitive = i, t.isString = o, t.isNullOrWhiteSpace = function (t) {
        return null == t || t.replace(/\s/g, "").length < 1
    }, t.isNumber = s, t.isInt = a, t.isBoolean = u, t.isFunction = l, t.isUndefined = function (t) {
        return void 0 === t
    }, t.isDate = c, t.isArray = h, t.isObject = p, t.isEmpty = function (t) {
        ...
        if (t.touches && t.touches.length > 0 && (t = t.touches[0]), s(t.clientX) && s(t.clientY)) return new I(t.clientX + pageXOffset, t.clientY + pageYOffset);
        throw"Mouse or touch event expected."
    }, t.getType = f, t.getTypes = function (t) {
        var e = [];
        if (t && t.length > 0) {
            var n = t[0];
            for (var r in n) for (var o = null, s = 0; s < t.length && s < 1e3 && null == o; s++) i(o = t[s][r]) && e.push({
                binding: r,
                dataType: f(o)
            })
        }
        return e
    }, t.changeType = d, t.toFixed = function (t, e, n) {
        if (n) {
        ...
        if ((e = m(e)).match(/\{.*"count".*:.*"when".*:.*\}/)) try {
            var i = JSON.parse(e);
            if (o(i.count)) {
                var a = n[i.count], u = i.when;
                if (s(a) && p(u)) {
                    var l = u[a] || u.other;
                    o(l) && (e = l)
                }
        ...
        return e.replace(/\{(.*?)(:(.*?))?\}/g, function (e, i, o, s) {
            var a = e;
            return i && "{" != i[0] && n && (a = n[i], s && (a = t.Globalize.format(a, s)), r && (a = r(n, i, s, a))), null == a ? "" : a
        })
    }, t.clamp = function (t, e, n) {
        return null != t && (null != n && t > n && (t = n), null != e && t < e && (t = e)), t
    }, t.copy = function e(n, r) {
        if (r) for (var i in r) if ("_" != i[0]) {
            g(i in n, 'Unknown property "' + i + '".');
            var o = r[i];
            n._copy && n._copy(i, o) || (n[i] instanceof t.Event ? l(o) && n[i].addHandler(o) : !p(o) || "undefined" != typeof Element && o instanceof Element || !n[i] || "itemsSource" == i ? n[i] = o : e(n[i], o))
        }
    }, t.assert = g, t._deprecated = function (t, e) {
        console.error('** WARNING: "' + t + '" has been deprecated; please use "' + e + '" instead.')
    }, t.asString = m, t.asNumber = _, t.asInt = function (t, e, n) {
        if (void 0 === e && (e = !1), void 0 === n && (n = !1), g(e && null == t || a(t), "Integer expected."), n && t && t < 0) throw"Positive integer expected.";
        return t
    }, t.asBoolean = v, t.asDate = function (t, n) {
        if (void 0 === n && (n = !1), o(t)) {
            var r = d(t, e.Date, "r");
            c(r) && (t = r)
        }
        return g(n && null == t || c(t), "Date expected."), t
    }, t.asFunction = y, t.asArray = function (t, e) {
        return void 0 === e && (e = !0), g(e && null == t || h(t), "Array expected."), t
    }, t.asType = function (t, e, n) {
        return void 0 === n && (n = !1), t = r(t, e), g(n || null != t, e + " expected."), t
    }, t.asEnum = function (t, e, n) {
        if (void 0 === n && (n = !1), null == t && n) return null;
        var r = e[t];
        return g(null != r, 'Invalid enum value: "' + t + '"'), s(r) ? r : t
    }, t.asCollectionView = function (e, n) {
        if (void 0 === n && (n = !0), null == e && n) return null;
        var i = r(e, "ICollectionView");
        return null != i ? i : (h(e) || g(!1, "Array or ICollectionView expected."), new t.collections.CollectionView(e))
        ...
        return t && o(t) && (t = t.replace(/[&<>"'\/]/g, function (t) {
            return b[t]
        })), t
    };
    var b = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;"};
    ...
    function w(e, n) {
        if (e && n) {
            if (e instanceof HTMLElement && e.classList && !t.isIE9()) return void (n.indexOf(" ") < 0 ? e.classList.add(n) : n.split(" ").forEach(function (t) {
                e.classList.add(t)
            }));
    ...
    function E(e, n) {
        if (e && n) {
            if (e instanceof HTMLElement && e.classList && !t.isIE9()) return void (n.indexOf(" ") < 0 ? e.classList.remove(n) : n.split(" ").forEach(function (t) {
    ...
    function S(t) {
        return t instanceof Element ? t : o(t) ? document.querySelector(t) : t && t.jquery ? t[0] : null
    }
    ...
    function F(t, e) {
        if (t && l(t.closest)) return t.closest(e);
        var n = t ? t.matches || t.webkitMatchesSelector || t.msMatchesSelector || t.mozMatchesSelector : null;
        if (n) for (; t && 1 === t.nodeType; t = t.parentElement || t.parentNode) if (n.call(t, e)) return t;
        return null
    }
    ...
    t.toPlainText = function (t) {
    ...
    }, t.hasClass = C, t.addClass = w, t.removeClass = E, t.toggleClass = A, t.setAttribute = x, t.setAriaLabel = function (t, e) {
        x(t, "aria-label", e)
    }, t.setSelectionRange = function (t, e, n) {
        if (void 0 === n && (n = e), g(t instanceof HTMLInputElement || t instanceof HTMLTextAreaElement, "INPUT or TEXTAREA element expected"), O(document.body, t) && !t.disabled && t.offsetHeight) try {
            return t.setSelectionRange(e, n, "backward"), t.focus(), !0
        } catch (t) {
        }
        return !1
    ...
    }, t.getActiveElement = T, t.moveFocus = function (e, n) {
        var r = function e(n) {
            for (var r = [], i = n.querySelectorAll("input,select,textarea,button,a,div"), o = 0; o < i.length; o++) {
                var s = i[o];
                if (s.offsetHeight > 0 && s.tabIndex > -1 && !s.disabled && !F(s, "[disabled],.wj-state-disabled")) {
                    if (s instanceof HTMLAnchorElement && !s.hasAttribute("href")) continue;
                    if (t.isIE() && !s.hasAttribute("tabindex")) {
                        if (s instanceof HTMLDivElement) continue;
                        var a = t.Control.getControl(F(s, ".wj-flexgrid"));
                        if (a && 0 == a.keyActionTab) continue
                    }
                    !t.Control.getControl(s) && e(s).length || r.push(s)
                }
            }
            return r
        }(e), i = 0;
        if (n) {
            var o = r.indexOf(T());
            o > -1 && (i = (o + n + r.length) % r.length)
        }
        if (i < r.length) {
            var s = r[i];
            return s.focus(), s instanceof HTMLInputElement && s.select(), !0
        }
        return !1
    }, t.getElement = S, t.createElement = function (t, e) {
        var n = document.createElement("div");
        return n.innerHTML = t, 1 == n.children.length && (n = n.children[0]), e && (e = S(e)).appendChild(n), n
    }, t.setText = function (t, e) {
        t.textContent = e || ""
    }, t.contains = O, t.closest = F, t.closestClass = function (t, e) {
        return F(t, "." + e)
    }, t.enable = function (t, e) {
        var n = !e;
        A(t, "wj-state-disabled", n), x(t, "disabled", n ? "true" : null);
        ...
        return new M(e.left + pageXOffset, e.top + pageYOffset, e.width, e.height)
    }, t.setCss = function t(e, n) {
        if (g(p(n), "css parameter should be an object"), e instanceof Array) for (var r = 0; r < e.length; r++) t(e[r], n); else if (e && e.style) {
            var i = e.style;
            for (var o in n) {
                var s = n[o];
                "number" == typeof s && o.match(/width|height|left|top|right|bottom|size|padding|margin'/i) && (s += "px"), i[o] !== s && (i[o] = s)
            }
        }
    }, t.animate = function (e, n, r) {
        null == n && (n = t.Control._ANIM_DEF_DURATION), null == r && (r = t.Control._ANIM_DEF_STEP), e = y(e), n = _(n, !1, !0), r = _(r, !1, !0);
    ...
    var I = function () {
        function t(t, e) {
            void 0 === t && (t = 0), void 0 === e && (e = 0), this.x = _(t), this.y = _(e)
        }
    ...
    var P = function () {
        function t(t, e) {
            void 0 === t && (t = 0), void 0 === e && (e = 0), this.width = _(t), this.height = _(e)
        }
    ...
    var M = function () {
        function t(t, e, n, r) {
            this.left = _(t), this.top = _(e), this.width = _(n), this.height = _(r)
        }
        ...
        return Object.defineProperty(t.prototype, "right", {
            ...
            return null != e.left ? new t(e.left, e.top, e.width, e.height) : null != e.x ? new t(e.x, e.y, e.width, e.height) : void g(!1, "Invalid source rectangle.")
            ...
            if (e instanceof I) return e.x >= this.left && e.x <= this.right && e.y >= this.top && e.y <= this.bottom;
            if (e instanceof t) {
                var n = e;
                return n.left >= this.left && n.right <= this.right && n.top >= this.top && n.bottom <= this.bottom
            }
            g(!1, "Point or Rect expected.")
    ...
    var D = function () {
        ...
        return e.addDays = function (t, n) {
            ...
            return c(t) && c(e) && t.getFullYear() == e.getFullYear() && t.getMonth() == e.getMonth() && t.getDate() == e.getDate()
        }, e.sameTime = function (t, e) {
            return c(t) && c(e) && t.getHours() == e.getHours() && t.getMinutes() == e.getMinutes() && t.getSeconds() == e.getSeconds()
        }, e.equals = function (t, e) {
            return c(t) && c(e) && t.getTime() == e.getTime()
            ...
            return h(i.fiscalYearOffsets) ? e.addMonths(n, -i.fiscalYearOffsets[r ? 0 : 1]) : n
            ...
            var u = new Date(t, e, n, r, i, o, s), l = u.getFullYear();
            return t < 100 && l >= 1900 && u.setFullYear(u.getFullYear() - 1900), u
        }, e.clone = function (t) {
            return e.fromDateTime(t, t)
        }, e
    }();
    t.DateTime = D, t.httpRequest = function (t, e) {
        e || (e = {});
        var n = e.method ? m(e.method).toUpperCase() : "GET", r = null == e.async || v(e.async), i = e.data;
        if (null != i && "GET" == n) {
            var a = [];
            for (var u in i) {
                var h = i[u];
                c(h) && (h = h.toJSON()), a.push(u + "=" + h)
            }
            a.length && (t += (t.indexOf("?") < 0 ? "?" : "&") + a.join("&")), i = null
        }
        var f = new XMLHttpRequest;
        f.URL_DEBUG = t;
        var d = !1;
        if (null == i || o(i) || (d = p(i), i = JSON.stringify(i)), f.onload = function () {
            4 == f.readyState && (f.status < 300 ? e.success && y(e.success)(f) : e.error && y(e.error)(f), e.complete && y(e.complete)(f))
        }, f.onerror = function () {
            if (!l(e.error)) throw"HttpRequest Error: " + f.status + " " + f.statusText;
            e.error(f)
        }, f.open(n, t, r, e.user, e.password), e.user && e.password && f.setRequestHeader("Authorization", "Basic " + btoa(e.user + ":" + e.password)), d && f.setRequestHeader("Content-Type", "application/json"), e.requestHeaders) for (var g in e.requestHeaders) f.setRequestHeader(g, e.requestHeaders[g]);
        return s(e.timeout) && (f.timeout = e.timeout), l(e.beforeSend) && e.beforeSend(f), f.send(i), f
    };
    var j = {};
    t._registerModule = function (t, e) {
        j[t] = e;
        var n = "undefined" != typeof window ? window : "undefined" != typeof self ? self : null;
        if (n) {
            for (var r = t.split("."), i = r.length - 1, o = n, s = 0; s < i; s++) {
                var a = r[s];
                o = o[a] = o[a] || {}
            }
            o[r[i]] = e
        }
    }, t._getModule = function (t) {
        return j[t]
    }
}(wijmo || (wijmo = {})), function (t) {
    "use strict";
    var e = function () {
        ...
        return Object.defineProperty(e.prototype, "r", {
            ...
            var o = e._rgbToHsl(n.r, n.g, n.b), s = e._rgbToHsl(r.r, r.g, r.b), a = 1 - i, u = n.a * a + r.a * i,
                l = [o[0] * a + s[0] * i, o[1] * a + s[1] * i, o[2] * a + s[2] * i], c = e._hslToRgb(l[0], l[1], l[2]);
            return e.fromRgba(c[0], c[1], c[2], u)
            ...
            if (0 == n.indexOf("rgb")) {
                ...
                if (o > -1 && s > -1) if ((a = n.substr(o + 1, s - (o + 1)).split(",")).length > 2) return this.r = parseInt(a[0]), this.g = parseInt(a[1]), this.b = parseInt(a[2]), this.a = a.length > 3 ? parseFloat(a[3]) : 1, !0
            }
            if (0 == n.indexOf("hsl")) {
                var a;
                o = n.indexOf("("), s = n.indexOf(")");
                if (o > -1 && s > -1) if ((a = n.substr(o + 1, s - (o + 1)).split(",")).length > 2) {
                    var u = parseInt(a[0]) / 360, l = parseInt(a[1]), c = parseInt(a[2]);
                    a[1].indexOf("%") > -1 && (l /= 100), a[2].indexOf("%") > -1 && (c /= 100);
                    var h = e._hslToRgb(u, l, c);
            ...
            var o, s, a;
            if (t.assert(n >= 0 && n <= 1 && r >= 0 && r <= 1 && i >= 0 && i <= 1, "bad HSL values"), 0 == r) o = s = a = i; else {
                var u = i < .5 ? i * (1 + r) : i + r - i * r, l = 2 * i - u;
                o = e._hue2rgb(l, u, n + 1 / 3), s = e._hue2rgb(l, u, n), a = e._hue2rgb(l, u, n - 1 / 3)
            }
            ...
            var i = t.clamp(r * (2 - n) / 2, 0, 1), o = 1 - Math.abs(2 * i - 1),
    ...
    "use strict";
    t.culture = "undefined" != typeof window && window.wijmo && window.wijmo.culture || {
        Globalize: {
            numberFormat: {
                ".": ".",
                ",": ",",
    ...
    var e = function () {
        ...
        return e.format = function (n, r, i, o) {
            ...
            var s, a = t.culture.Globalize.numberFormat, u = r ? r.match(/([a-z])(\d*)(,*)(.*)/i) : null,
                l = u ? u[1].toLowerCase() : "n",
                c = u && u[2] ? parseInt(u[2]) : "c" == l ? a.currency.decimals : n == Math.round(n) ? 0 : 2,
                h = u && u[3] ? 3 * u[3].length : 0, p = a["."] || ".", f = a[","] || ",", d = a["-"] || "-";
            if (h && (n /= Math.pow(10, h)), "d" == l || "x" == l) {
                for (s = Math.round(Math.abs(n)).toString("d" == l ? 10 : 16); s.length < c;) s = "0" + s;
                return n < 0 && (s = d + s), r && "X" == r[0] && (s = s.toUpperCase()), s
            }
            if ("p" == l && (n = e._shiftDecimal(n, 2), n = t.toFixed(n, c, o)), o && "p" != l && (n = t.toFixed(n, c, !0)), s = "c" == l || "p" == l ? e._toFixedStr(Math.abs(n), c) : e._toFixedStr(n, c), (i || "g" == l) && s.indexOf(".") > -1 && (s = (s = s.replace(/(\.[0-9]*?)0+$/g, "$1")).replace(/\.$/, "")), "." != p && (s = s.replace(".", p)), "-" != d && (s = s.replace("-", d)), f && ("n" == l || "c" == l || "p" == l)) {
            ...
            var i = t.culture.Globalize.numberFormat, o = i["-"] || "-", s = i["%"] || "%",
                ...
                l = r ? r.match(/,+/) : null, c = l ? 3 * l[0].length : 0, h = 0;
            if (!r || "x" != r[0] && "X" != r[0]) {
                var p = i["."] || ".", f = new RegExp("[^\\d\\" + p + "]", "g");
                n = n.replace(f, "").replace(p, "."), h = parseFloat(n)
            } else n = n.replace(/[^0-9a-f]+.*$/gi, ""), h = parseInt(n, 16);
            return u && (h = e._shiftDecimal(h, -2)), h * a * Math.pow(10, c)
        }, e.parseDate = function (n, r, i) {
            if (!(n = t.asString(n))) return null;
            if ("u" == r) return new Date(n);
            var o;
            if ("R" == r || "r" == r) {
                var s = n.match(/(([0-9]+)\-([0-9]+)\-([0-9]+))?\s?(([0-9]+):([0-9]+)(:([0-9]+))?)?/);
                return s[1] || s[5] ? (o = s[1] ? new Date(parseInt(s[2]), parseInt(s[3]) - 1, parseInt(s[4])) : new Date, s[5] && (o.setHours(parseInt(s[6])), o.setMinutes(parseInt(s[7])), o.setSeconds(s[8] ? parseInt(s[9]) : 0))) : o = new Date(n), isNaN(o.getTime()) ? null : o
            }
            r = e._expandFormat(r || "d");
            var a, u, l, c, h, p, f = t.culture.Globalize.calendar, d = e._CJK,
                g = new RegExp("(\\" + f["/"] + ")|(\\" + f[":"] + ")|(\\d+)|([" + d + "\\.]{2,})|([" + d + "]+)", "gi"),
                m = n.match(g), _ = e._parseDateFormat(r), v = 0, y = -1, b = 0, C = 1, w = 0, E = 0, A = 0, x = 0,
                T = -1;
            if (!(m && m.length && _ && _.length)) return null;
            for (var S = 0; S < _.length && m; S++) {
                var O = S - v, F = O > -1 && O < m.length ? m[O] : "", I = _[S].length;
                switch (_[S]) {
                    case"EEEE":
                    case"EEE":
                    case"EE":
                    ...
                    case"yy":
                    case"y":
                        I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), y = parseInt(F), h = 4 == F.length;
                        break;
                    case"MMMM":
                    case"MMM":
                        c = !0;
                        var P = F.toLowerCase();
                        b = -1;
                        for (var M = 0; M < 12; M++) if (0 == f.months[M].toLowerCase().indexOf(P)) {
                            b = M;
                            break
                        }
                        if (b > -1) break;
                    case"MM":
                    case"M":
                        c = !0, I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), b = parseInt(F) - 1;
                        break;
                    case"dddd":
                    case"ddd":
                        a = !0;
                    ...
                    case"dd":
                    case"d":
                        I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), C = parseInt(F), u = !0;
                        break;
                    case"hh":
                    case"h":
                        I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), w = 12 == (w = parseInt(F)) ? 0 : w;
                        break;
                    case"HH":
                        I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), w = parseInt(F);
                        break;
                    case"H":
                        w = parseInt(F);
                        break;
                    case"mm":
                    case"m":
                        I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), E = parseInt(F);
                        break;
                    case"ss":
                    case"s":
                        I > 1 && F.length > I && (m[O] = F.substr(I), F = F.substr(0, I), v++), A = parseInt(F);
                        break;
                    case"fffffff":
                    case"FFFFFFF":
                    case"ffffff":
                    ...
                    case"f":
                    case"F":
                        x = parseInt(F) / Math.pow(10, I - 3);
                        break;
                    case"tt":
                    case"t":
                        F = F.toUpperCase(), w < 12 && f.pm.indexOf(F) > -1 && (w += 12);
                        break;
                    case"q":
                    case"Q":
                    case"u":
                    ...
                    case"gg":
                    case"g":
                        T = f.eras.length > 1 ? e._getEra(F, f) : -1;
                        break;
                    case"/":
                    case":":
                        if (F && F != f[_[S]]) return null;
                        break;
                    case"K":
                        break;
                    default:
                        e._unquote(_[S]).trim() != F.trim() && v++
                }
            }
            if (c && u && (isNaN(w) && (w = 0), isNaN(E) && (E = 0), isNaN(A) && (A = 0)), b < 0 || b > 11 || isNaN(b) || C < 1 || C > 31 || isNaN(C) || w < 0 || w > 24 || isNaN(w) || E < 0 || E > 60 || isNaN(E) || A < 0 || A > 60 || isNaN(A)) return null;
            if (p) {
                if (!c) return null;
                var D = t.culture.Globalize.calendar;
                if (t.isArray(D.fiscalYearOffsets)) {
                    var j = "E" == p[0], L = b - D.fiscalYearOffsets[j ? 0 : 1];
                    y += L > 11 ? -1 : L < 0 ? 1 : 0
                }
            }
            if (a && !u) return null;
            if (l && !c) return null;
            if (y < 0) y = t.isDate(i) ? i.getFullYear() : (new Date).getFullYear(); else if (T > -1) y = y + f.eras[T].start.getFullYear() - 1; else if (y < 100 && !h) {
                var N = t.isNumber(f.twoDigitYearMax) ? f.twoDigitYearMax : 2029;
                N > 99 && (y += y + 2e3 <= N ? 2e3 : 1900)
            }
            return C > new Date(y, b + 1, 0).getDate() ? null : (o = t.DateTime.newDate(y, b, C, w, E + 0, A, x), isNaN(o.getTime()) ? null : o)
            ...
            var n = t.toString(), r = n.indexOf("."), i = e - (n.length - r) + 1, o = n.indexOf("e") > -1;
            if (!o && r > -1 && i >= 0) return n + Array(i + 1).join("0");
            r && !o && "5" == n[n.length - 1] && (t = +(Math.round(+(Math.abs(t) + "e" + e)) + "e" + -e) * (t < 0 ? -1 : 1));
            return t.toFixed(e)
            ...
            var o, s = t.culture.Globalize.calendar, a = 0, u = 0, l = 0, c = i.length;
            switch (i) {
                case"yyyy":
                case"yyy":
                case"yy":
                ...
                case"MM":
                case"M":
                    return e._zeroPad(n.getMonth() + 1, c);
                case"dddd":
                ...
                case"hh":
                case"h":
                    return e._zeroPad(e._h12(n), c);
                case"HH":
                case"H":
                    return e._zeroPad(n.getHours(), c);
                case"mm":
                case"m":
                    return e._zeroPad(n.getMinutes(), c);
                case"ss":
                case"s":
                    return e._zeroPad(n.getSeconds(), c);
                case"fffffff":
                case"FFFFFFF":
                case"ffffff":
                case"FFFFFF":
                ...
                case"f":
                case"F":
                    return l = n.getMilliseconds() * Math.pow(10, c - 3), "f" == i[0] ? e._zeroPad(l, c) : l.toFixed(0);
                case"tt":
            ...
            if (t.isDate(e)) {
                for (var r = 0; r < n.eras.length; r++) if (e >= n.eras[r].start) return r
            } else if (t.isString(e)) for (r = 0; r < n.eras.length; r++) if (n.eras[r].name && (0 == n.eras[r].name.indexOf(e) || 0 == n.eras[r].symbol.indexOf(e))) return r;
            return -1
            ...
            e < 0 && (n = r + n);
            var i = n.indexOf(".");
            return i < 0 && (i = (n += ".").indexOf(".")), e > 0 && (n += r), i += e, n = (n = n.replace(".", "")).substr(0, i) + "." + n.substr(i), parseFloat(n)
    ...
    t.Globalize = e, t._updateCulture = function () {
        ...
        t.culture[e] = "undefined" != typeof window && window.wijmo.culture[e] || n
    }
}(wijmo || (wijmo = {})), function (t) {
    "use strict";
    var e = function () {
        ...
        return Object.defineProperty(e.prototype, "input", {
            ...
            var t = this._tbx, e = t.value.length < 2, n = t.selectionStart, r = n > 0 ? t.value[n - 1] : "",
                i = t.value;
            ...
            for (var e, r = this._msk, i = "|", o = 0; r && o < r.length; o++) switch (r[o]) {
                ...
                case"$":
                    ...
                    for (var s = 0; s < e.length; s++) this._mskArr.push(new n(e[s]));
                    break;
                case"<":
                case">":
                case"|":
            ...
            for (o = 0; o < this._mskArr.length; o++) {
                ...
                if (a.literal) for (s = 0; s < o; s++) {
                    var u = this._mskArr[s];
                    if (u.wildCard && this._isCharValid(u.wildCard, a.literal)) {
                        a.vague = !0;
                        break
                    }
                }
    ...
    "use strict";
    var e = "undefined" != typeof navigator && null != navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i);
    t.isMobile = function () {
        return e
    };
    var n = "undefined" != typeof navigator && null != navigator.userAgent.match(/Firefox\//);
    ...
    t.isFirefox = r;
    var i = "undefined" != typeof navigator && null != navigator.userAgent.match(/^((?!chrome|android).)*safari/i);
    t.isSafari = function () {
        return i
    };
    var o = "undefined" != typeof navigator && null != navigator.userAgent.match(/Edge\//);
    t.isEdge = function () {
        return o
    };
    var s = "undefined" != typeof navigator && null != navigator.userAgent.match(/MSIE |Trident\/|Edge\//);
    t.isIE = function () {
        return s
    };
    var a = !1;
    ...
    "undefined" != typeof document && document.addEventListener("test", function (t) {
        ...
        return l ? {capture: t, passive: e} : t
    };
    var c = !1;
    if ("undefined" != typeof document && document.createElement("div").focus({
        ...
        return c
    }, t._startDrag = function (t, e) {
        t.effectAllowed = e, r() && t.setData("text", "")
    ...
    var e = function () {
        ...
        return Object.defineProperty(e.prototype, "title", {
            ...
            t.isString(e) ? n.write(e) : e instanceof HTMLElement ? n.write(e.outerHTML) : t.assert(!1, "child should be an HTML element or a string.")
        }, e.prototype.print = function (e) {
            var n = this;
            this._iframe && (this._close(), setTimeout(function () {
                var r = n._iframe.contentWindow, i = "onafterprint" in r;
                i && (r.onafterprint = function () {
                    n._afterPrint(e)
                }), !(t.isIE() && null == r.document.body) && document.queryCommandSupported("print") ? r.document.execCommand("print", !0, null) : (r.focus(), r.print()), i || n._afterPrint(e)
            }, 100))
        }, e.prototype._afterPrint = function (e) {
            document.body.removeChild(this._iframe), this._iframe = null, t.isFunction(e) && e()
        }, e.prototype._getDocument = function () {
            if (!this._iframe) {
                var e = this._iframe = document.createElement("iframe");
                t.addClass(e, "wj-printdocument"), t.setCss(e, {
                    position: "fixed",
                    left: 32e3,
                    top: 32e3
            ...
            if (e.close(), e.title = null != this.title ? this.title : document.title, e.title && e.title.trim() || (e.title = " "), this._copyCss) {
                for (var n = document.head.querySelectorAll("link"), r = 0; r < n.length; r++) {
                    ...
                    if (i.href.match(/\.css$/i) && i.rel.match(/stylesheet/i)) {
                        var o = t.httpRequest(i.href, {async: !1});
                        this._addStyle(o.responseText)
                    }
                }
                var s = document.head.querySelectorAll("STYLE");
                for (r = 0; r < s.length; r++) this._addStyle(s[r].textContent)
            }
            if (this._css) for (r = 0; r < this._css.length; r++) {
                var a = e.createElement("style");
                o = t.httpRequest(this._css[r], {async: !1});
                a.textContent = o.responseText, e.head.appendChild(a)
            }
    ...
    !function (t) {
        ...
        var o = 0, s = 0, a = 0, u = 0, l = null, c = null, h = null, p = i ? new t.Binding(i) : null;
        if ((n = t.asEnum(n, e)) == e.CntAll) return r.length;
        for (var f = 0; f < r.length; f++) {
            var d = r[f];
            if (p && (d = p.getValue(d)), n == e.First) return d;
            null != d && (o++, (null == l || d < l) && (l = d), (null == c || d > c) && (c = d), h = d, t.isNumber(d) && !isNaN(d) ? (s++, a += d, u += d * d) : t.isBoolean(d) && (s++, 1 == d && (a++, u++)))
        }
        var g = 0 == s ? 0 : a / s;
        switch (n) {
            case e.Avg:
    ...
    !function (e) {
        ...
        var o = function (n) {
            ...
            return __extends(r, n), r.prototype.push = function () {
                ...
                t >= this.length && (this.length = t + 1), this.splice(t, 1, e)
        ...
        var n = function () {
            ...
            return n.prototype._copy = function (n, r) {
                switch (n) {
                    case"sortDescriptions":
                        ...
                        for (var i = t.asArray(r), o = 0; o < i.length; o++) {
                            var s = i[o];
                            t.isString(s) && (s = new e.SortDescription(s, !0)), this.sortDescriptions.push(s)
                        }
                        return !0;
                    case"groupDescriptions":
                        ...
                        for (o = 0; o < a.length; o++) {
                            s = a[o];
                            t.isString(s) && (s = new e.PropertyGroupDescription(s)), this.groupDescriptions.push(s)
                        }
                        return !0;
                    case"currentItem":
                ...
                get: function () {
                    ...
                    e != this._stableSort && (this._stableSort = t.asBoolean(e), this.refresh())
                }, enumerable: !0, configurable: !0
            }), Object.defineProperty(n.prototype, "sortNullsFirst", {
                get: function () {
                    return this._nullsFirst
                }, set: function (e) {
                    e != this._stableSort && (this._nullsFirst = t.asBoolean(e), this.refresh())
                }, enumerable: !0, configurable: !0
                ...
                var t = this._srtDsc, e = this._srtCvt, r = this._srtCmp, i = this._nullsFirst ? -1 : 1,
                    o = n._collator, s = !0, a = 0;
                return function (n, u) {
                    for (var l = 0; l < t.length; l++) {
                        var c = t[l], h = c._bnd.getValue(n), p = c._bnd.getValue(u);
                        if (e && (h = e(c, n, h, s), p = e(c, u, p, !1), s = !1), r && null != (a = r(h, p))) return c.ascending ? +a : -a;
                        if (h != h && (h = null), p != p && (p = null), null != h && null == p) return -1 * i;
                        if (null == h && null != p) return 1 * i;
                        if ("string" == typeof h && "string" == typeof p) {
                            if (o) {
                                if (0 != (a = o.compare(h, p))) return c.ascending ? +a : -a;
                                continue
                            }
                            var f = h.toLowerCase(), d = p.toLowerCase();
                            f != d && (h = f, p = d)
                        }
                        if (0 != (a = h < p ? -1 : h > p ? 1 : 0)) return c.ascending ? +a : -a
                    }
                    return 0
                }
                ...
                if (null != t) {
                    this._committing = !0;
                    var r = this._getChangedFields(t, n), i = this._pendingRefresh;
                    this._edtItem = null, this._edtClone = null;
                    var o = this._pgView.indexOf(t), s = this._digest;
                    if (this._needRefresh(r) && this._performRefresh(), r && this._trackItemChanged(t), this._pgView.indexOf(t) != o || s != this._digest || i ? this._raiseCollectionChanged() : this._raiseCollectionChanged(e.NotifyCollectionChangedAction.Change, t, o), this.commitNew(), this._committing = !1, this.sourceCollection instanceof e.ObservableArray) {
                        this._updating++;
                        var a = new e.NotifyCollectionChangedEventArgs(e.NotifyCollectionChangedAction.Change, t);
                        this.sourceCollection.onCollectionChanged(a), this._updating--
                    }
                }
                ...
                if (r && (this._newItem = null), n == this._edtItem && this.cancelEdit(), this.canRemove) {
                    ...
                    if (i > -1) {
                        ...
                        var l = this.sortDescriptions.length > 0, c = this.pageSize > 0 && this._pgIdx > -1;
                        l || c || s != this._getGroupsDigest(this.groups) ? this._raiseCollectionChanged() : this._raiseCollectionChanged(e.NotifyCollectionChangedAction.Remove, n, i), this.currentItem !== o && this.onCurrentChanged()
                    }
            ...
            }, n.prototype._needRefresh = function (t) {
                if (!t) return !1;
                if (this._filter) return !0;
                for (var n = 0; n < this._srtDsc.length; n++) if (t.indexOf(this._srtDsc[n].property) > -1) return !0;
                for (n = 0; n < this._grpDesc.length; n++) {
                    var r = this._grpDesc[n];
                    if (!(r instanceof e.PropertyGroupDescription) || t.indexOf(r.propertyName) > -1) return !0
                }
                return !1
            }, n.prototype._sameContent = function (t, e) {
                return null == this._getChangedFields(t, e)
            }, n.prototype._getChangedFields = function (e, n) {
                t.assert(null != n && null != e, "Two objects expected");
                var r = {};
                for (var i in n) this._sameValue(e[i], n[i]) || (r[i] = !0);
                for (var i in e) this._sameValue(e[i], n[i]) || (r[i] = !0);
                var o = Object.keys(r);
                ...
                return e.forEach(function (e) {
                    for (var s = r, a = n._grpDesc.length, u = "", l = 0; l < a; l++) {
                        var c = n._grpDesc[l], h = c.groupNameFromItem(e, l), p = l == a - 1;
                        !(o = i[u]) && t.isPrimitive(h) && (o = {}, i[u] = o);
                        var f = n._getGroup(c, s, o, h, l, p);
                        u += "/" + h, f._path = u, p && f.items.push(e), s = f.groups
                    }
                }), r
                ...
                for (var e = [], n = 0; n < t.length; n++) {
                    ...
                    for (o = 0, s = r._items.length; o < s; o++) e.push(r._items[o])
                }
                return e
                ...
                if (i && t.isPrimitive(o)) {
                    if (u = i[o]) return u
                } else for (var l = 0; l < n.length; l++) if (e.namesMatch(n[l].name, o)) return n[l];
                var c = new r(e, o, s, a);
                return n.push(c), i && (i[o] = c), c
    ...
    var o = function (e) {
        function n(r, i, o) {
            ...
            if (1 == o) {
                ...
                var l = n._szObserver, c = window.ResizeObserver;
                !l && c && (n._szObserver = l = new c(function (t) {
                    t.forEach(function (t) {
                        var e = n.getControl(t.target);
                        e && e._handleResize()
                    })
                })), l ? l.observe(a) : u(window, "resize", s._handleResize.bind(s))
            }
            var h = s._handleFocusBlur.bind(s);
            u(a, "focus", h, !0), u(a, "blur", h, !0);
            var p = s._handleDisabled.bind(s);
            if (u(a, "mousedown", p, !0), u(a, "mouseup", p, !0), u(a, "click", p, !0), u(a, "dblclick", p, !0), u(a, "wheel", p, t.getEventOptions(!0, !0)), u(a, "keydown", function (e) {
                ...
                var f = document, d = s._handleTouchStart, g = s._handleTouchEnd, m = t.getEventOptions(!0, !0);
                "ontouchstart" in window ? (f.addEventListener("touchstart", d, m), "touchend,touchcancel".split(",").forEach(function (t) {
                    f.addEventListener(t, g, m)
                })) : "onpointerdown" in window && (f.addEventListener("pointerdown", d, m), "pointerup,pointercancel".split(",").forEach(function (t) {
                    f.addEventListener(t, g, m)
                }))
            }
            return s
        ...
        return __extends(n, e), n.prototype.getTemplate = function () {
            ...
            for (var l = a.querySelectorAll("a.wj-btn"), c = 0; c < l.length; c++) {
                var h = l[c];
                t.setAttribute(h, "role", "button", !0), t.setAttribute(h, "href", "", !0), t.setAttribute(h, "draggable", !1, !0)
            }
            var p = a.querySelectorAll("button");
            for (c = 0; c < p.length; c++) t.setAttribute(p[c], "type", "button", !0);
            ...
            if (this._e) {
                ...
                var o = n._szObserver;
                for (var s in o && o.unobserve(this._e), this._toInv && (clearTimeout(this._toInv), this._toInv = null), this.removeEventListener(), this) {
                    if (s.length > 2 && 0 == s.indexOf("on")) (u = this[s[2].toLowerCase() + s.substr(3)]) instanceof t.Event && u.removeAllHandlers()
                }
                var a = this.collectionView;
                if (a instanceof t.collections.CollectionView) for (var s in a) {
                    var u;
                    (u = a[s]) instanceof t.Event && u.removeHandler(null, this)
                }
            ...
            return t.contains(this._e, t.getActiveElement(), !0)
            ...
            setTimeout(function () {
                for (var e = t.EventArgs.empty, r = document.body.querySelectorAll(".wj-state-focused"), i = 0; i < r.length; i++) {
                    (u = n.getControl(r[i])) && u._focus && !u.containsFocus() && (t.removeClass(u._e, "wj-state-focus"), u._focus = !1, u._updateState(), u.onLostFocus(e))
                }
                var o = t.getActiveElement();
                if (o) for (var s = !0, a = o; a;) {
                    var u;
                    (u = n.getControl(a)) && !u._focus && u.containsFocus() && (s && (t.addClass(a, "wj-state-focus"), s = !1), u._focus = !0, u._updateState(), u.onGotFocus(e)), a = a[n._OWNR_KEY] || a.parentNode
                }
            })
    ...
    t.showPopup = function (r, i, o, s, a) {
        ...
        if (i instanceof HTMLElement) {
            ...
            for (var l = i; l; l = l.parentElement) if ("DIALOG" == l.tagName || n(l) || "fixed" == getComputedStyle(l).position) {
                u = l;
                break
            }
        }
        ...
        var c = document.body, h = new t.Point(c.scrollLeft || pageXOffset, c.scrollTop || pageYOffset),
            p = document.documentElement, f = p.clientWidth / window.innerWidth;
        if (u != c || f > 1.005) {
            var d = u == c ? p : r.offsetParent || u;
            if (d == c && (d = u), d) {
        ...
        var y = getComputedStyle(r), b = parseFloat(y.marginTop) + parseFloat(y.marginBottom),
            ...
            E = t.hasClass(r, "wj-rtl") || "rtl" == r.getAttribute("dir"), A = new t.Point, x = null, T = p.clientWidth,
            S = p.clientHeight;
        if (i && null != i.clientX && null != i.clientY && null != i.pageX && null != i.pageY) i.clientX <= 0 && i.clientY <= 0 && i.target ? x = i.target.getBoundingClientRect() : (A.x = i.pageX - pageXOffset, A.y = i.pageY - pageYOffset, E && (A.x -= w.width)); else if (i instanceof t.Point) A = i, E && (A.x -= w.width); else if (i instanceof HTMLElement) x = i.getBoundingClientRect(); else if (i && null != i.top && null != i.left) x = i; else {
            ...
            A.x = (T - w.width) / 2, A.y = Math.round((S - w.height) / 2 * .7)
        }
        var O = parseFloat(y.minWidth);
        if (x) {
            O = Math.max(O, x.width), !t.isIE() || i && "TR" == i.tagName || (O -= r.offsetWidth - (r.clientWidth + parseInt(y.borderLeftWidth) + parseInt(y.borderRightWidth))), A.x = x.left;
            var F = x.top, I = S - x.bottom;
            A.y = o ? F > w.height || F > I ? x.top - w.height : x.bottom : I > w.height || I > F ? x.bottom : x.top - w.height
        }
        A.y + w.height > S - 20 && (A.y = Math.max(0, S - 20 - w.height)), A.x + w.width > T - 20 && (A.x = Math.max(0, T - 20 - w.width)), A.x = Math.max(0, A.x) + h.x, A.y = Math.max(0, A.y) + h.y;
        var P = {position: "absolute", opacity: s ? "0" : "", minWidth: O, zIndex: t.Control._POPUP_ZINDEX};
        0 == h.x ? (P.left = A.x, P.top = A.y) : P.transform = t.format("translate({x}px, {y}px)", A), i instanceof HTMLElement && (r[t.Control._OWNR_KEY] = i);
        var M = null;
        ...
        if (D instanceof HTMLElement && D.parentElement != document.body) {
            var j = Date.now(), L = D.getBoundingClientRect(), N = new t.Control(document.createElement("div"));
            r[t.Control._SCRL_KEY] = N, N.addEventListener(document, "scroll", function (n) {
                if (n.target != r.parentElement && Date.now() - j > 100 && t.contains(document, D) && !t.contains(r, n.target) && (n.target != document || null != i && "fixed" == r.style.position)) {
                    var o = D.getBoundingClientRect(), s = Math.abs(o.left - L.left), a = Math.abs(o.top - L.top);
                    (s > 1 || a > 1) && (e(r, !0), N.dispose())
                }
            }, !0)
        }
        return M
    ...
    var e = function () {
        ...
        return e.prototype.setTooltip = function (e, n) {
            ...
            e.length && (e.forEach(function (e) {
                t._detach(e.element)
            }), e.splice(0, e.length)), this._clearTimeouts()
    ...
    t._registerModule("wijmo", t)
}(wijmo || (wijmo = {})), function (t) {
    "use strict";
    var e = "The Wijmo license in this application ", n = {
        evl: "Wijmo Evaluation Version ({version})",
        prd: e + "is not valid for the <b>{control}</b> control.",
        ver: e + "is not valid for the version in use. The license version is <b>{licVer}</b>; the product version is <b>{version}</b>.",
        dmn: e + "is not valid for the current domain. The license domain is <b>{licDomain}</b>; the current domain is <b>{domain}</b>.",
        exp: e + "has expired. The license expiration date is <b>{expDate:d}</b>.",
        lic: e + "is invalid.",
        mss: e + "is not set.",
    ...
    function o(e, o, c) {
        var h = t.culture.Licensing || n, p = null;
        c ? !function (t, e) {
            if (e.Exp) {
                var n = e.Exp,
                    r = new Date(parseInt(n.substr(0, 4)) || 0, parseInt(n.substr(4, 2)) - 1 || 0, parseInt(n.substr(6, 2)) || 0),
                    i = Math.ceil((r.valueOf() - Date.now()) / 864e5);
                if (i <= 0) return !1
            }
            return !0
        }(0, c) ? p = h.exp : !function (e, n) {
            var r = n.Anl ? n.Anl.ver : null, i = t.getVersion();
            if (r && i) {
                var o = parseInt(r.replace("v", "")) + 10, s = parseInt(i.split(".")[1]);
                return o >= s
            }
            return !0
        }(0, c) ? p = h.ver : !function (t, e) {
            if (u() || !e.Dms) return !0;
            for (var n = location.hostname, r = e.Dms.split(","), i = 0; i < r.length; i++) if (s(n, r[i])) return !0;
            return !1
        }(0, c) ? p = h.dmn : !function (t, e) {
            var n = i(t);
            if (n && n.length >= 4) for (var r = 0; r < e.Prd.length; r++) if (e.Prd[r].C.indexOf(n) > -1) return !0;
            return !1
        }(e, c) ? p = h.prd : a(e, c) && (p = h.evl) : p = o ? h.lic : h.mss, p && function (e, i, o) {
            if (i = l(e, i, o), !r[" "] && !u() && !a(e, o)) {
                r[" "] = !0;
                var s = t.culture.Licensing || n,
                    c = '<div style="display:none;visibility:hidden;position:fixed;background:rgba(0,0,0,0.3);left:0;top:0;width:0px;height:0px;font-family: sans-serif;z-index:10000;"><div style="diplay:none;visibility:hidden;position:relative;background:white;width:0px;height:0px;padding:36pt;left:0px;top:0px;transform:translate(-50%,-50%)"><div><p style="font-size:150%;font-weight:bold">' + s.hdr + "</p><p>" + i + '</p></div><div style="text-align:right;margin-top:24pt"><button style="border:none;background:rgba(158,158,158,.2);padding:8px 16px">' + s.cls + "</button></div></div></div>",
                    h = t.createElement(c, document.body);
                h.addEventListener("click", function (e) {
                    e.target instanceof HTMLButtonElement && t.removeChild(h)
                })
            }
            if (!t.Control._wme) {
                var c = '<div style="display:none"><a href="' + ("ja" == t.culture.Globalize.name ? "https://www.grapecity.co.jp/developer/support/wijmo-license" : "https://www.grapecity.com/en/licensing/wijmo") + '" target="_blank" rel="noopener">' + l(e) + "</a></div>",
                    p = t.createElement(c), f = {
                        position: "fixed",
                        display: "none",
                        visibility: "hidden",
                ...
                t.setCss(p, f), document.body.appendChild(p), t.Control._wme = p;
                var d = new t.Tooltip;
                d.setTooltip(p, i)
            }
        }(e, p += "<br/><br/>" + h.ctc, c)
    ...
    function s(t, e) {
        ...
        return r || "*." != e.substr(0, 2) ? r : s(t, e.substr(2))
    }
    ...
    function u() {
        var t = location,
            e = atob("Xih8bG9jYWxob3N0fGZpZGRsZS5qc2hlbGwubmV0fHJ1bi5wbG5rci5jb3xzLmNvZGVwZW4uaW98bnVsbC5qc2Jpbi5jb218Lio/LnN0YWNrYmxpdHouaW98MTI3LjAuMC4xfFt3LV0rLmxvY2FsfFt3LV0rfDo6MSkk");
        return "file:" == t.protocol || new RegExp(e, "i").test(t.hostname)
    }

    function l(e, r, i) {
        (!r || r.trim().length < 15) && (r = (t.culture.Licensing || n).evl);
        (!r || r.trim().length < 15) && (r = atob("V2lqbW8gRXZhbHVhdGlvbiBWZXJzaW9uICh7dmVyc2lvbn0p"));
        var o = null;
        if (i && i.Exp) {
            var s = i.Exp;
    ...
    t._updateWme = function (e, n) {
        var s = t.Control._wme;
        if (!(s && t.contains(document.body, s) && s.offsetWidth && s.offsetHeight)) if (n) {
            var a = i(e);
            r[a] || (r[a] = !0, function (t, e, n, r) {
                var i = function (t, e) {
                    try {
                        e = "#" + e;
                        var n = t.indexOf(e);
                        if (n > -1) return {
                            prefix: t.substring(0, n), lic: JSON.parse(function (t) {
                                if (!t) return "";
                                var e = function (t) {
                                    for (var e = t.split(""), n = e.length - 5; n >= 0; n--) h(e, n + 1, n + 3, p), h(e, n, n + 2, p);
                                    return e.join("")
                                }(t);
                                ...
                                }(e = (e = (e = e.substr(n) + e.substr(0, n)).replace("#", "=")).replace("&", "=="))
                            }(t.substr(n + e.length)))
                        }
                    } catch (t) {
                    }
                ...
                }(s + JSON.stringify(o.D)) != o.H) return r();
                var a = window.msCrypto || window.crypto, u = a ? a.subtle : null;
                if (!u || !location.protocol.match(/^https/i)) return n(o.D);
                var l, m = {name: "RSASSA-PKCS1-v1_5", hash: {name: "SHA-256"}}, _ = {
                    alg: "RS256",
                    e: "AQAB",
                    kty: "RSA",
                    n: (l = e.publicKey, l.replace(/\+/g, "-").replace(/\//g, "_").replace(/\=+$/, ""))
                };
                _ = window.msCrypto ? d(JSON.stringify(_)) : _;
                try {
                    var v = g(u.importKey("jwk", _, m, !1, ["verify"]));
                    v.then(function (t) {
                        var e, i,
                            a = s + (e = f((i = JSON.stringify(o.D), btoa(encodeURIComponent(i).replace(/%([0-9A-F]{2})/g, function (t, e) {
                                return String.fromCharCode(parseInt(e, 16))
                            })))), String.fromCharCode.apply(null, new c(e))), l = g(u.verify(m, t, f(o.S), d(a)));
                        l.then(function (t) {
                            return t ? n(o.D) : r()
                        })
                    }, function () {
    ...
    var c = "undefined" == typeof window ? null : window.Uint8Array || window.TypedArray;
    ...
    function p(t) {
        return n = -1, (r = (e = t).charCodeAt(0)) >= 65 && r <= 90 ? e.toLowerCase() : r >= 97 && r <= 122 ? e.toUpperCase() : r >= 48 && r <= 57 ? String.fromCharCode(48 + (r - 48 + 10 + n) % 10) : e;
        var e, n, r
    }

    function f(t) {
        for (var e = atob(t), n = e.length, r = new c(n), i = 0; i < n; i++) r[i] = e.charCodeAt(i);
        return r.buffer
    }

    function d(t) {
        for (var e = new ArrayBuffer(t.length), n = new c(e), r = 0, i = t.length; r < i; r++) n[r] = t.charCodeAt(r);
        return e
    }
